...
class AdminController extends Controller
{
    ...
    // Viewing the page to Add new Product
    ...
    public function update_product(Request $request, $id){
        if(Auth::id()){
            ...
            $product -> save();
            $show_product = product::all();
            return redirect()->to('show_product')->with(compact('show_product')) -> with('message', 'Product Updated Successfully');
        }
        else{
            return redirect('login');
        }
    ...
    public function search_orderdata(Request $request){
        if(Auth::id()){
            $searchText = $request->search;

            $order = Order::where('name','LIKE',"%$searchText%")->orWhere('phone','LIKE',"%$searchText%")
            ->orWhere('product_title','LIKE',"%$searchText%")->orWhere('delivery_status','LIKE',"%$searchText%")
            ->get();
