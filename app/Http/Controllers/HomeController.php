...
class HomeController extends Controller
{
    ...
    public function stripePost(Request $request, $totalprice)
    {
        ...
        // Saving data from cart to order table
        $user = Auth::user();
    ...
    // This function is used to search and view the products on home page
    ...
    // This function is used to search and view the products on products page
