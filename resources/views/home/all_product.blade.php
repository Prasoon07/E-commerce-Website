...
<html>
   ...
   <body>
      ...
      <div style="text-align: center; padding-bottom:30px;">
        ...
        <h1 style="font-size: 40px; text-align: center; padding-top: 20px;
      ...
      <div style="padding-left: 20%;">
        ...
        <div style="display: none;" class="replyDisplay">
            <form action="{{url('add_reply')}}" method="POST">
                ...
                placeholder="Comment's reply here..."></textarea>
    ...
    <script type="text/javascript">
        ...
        function reply(caller){
            ...
            $('.replyDisplay').insertAfter($(caller));
            $('.replyDisplay').show();
        }
